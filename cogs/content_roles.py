...
``lfg_role_<event_type>`` keys (see :mod:`cogs._lfg_config`). That means a
single source of truth: whatever role is set as the LFG ping target for
ZvZ is also what members can self-assign here.
